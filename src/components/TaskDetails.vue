...
export default {
  ...
  methods: {
    getTaskProps() {
      api
        .getEntity("taskfields/" + this.taskId, null, null)
        .then(value => {
    ...
    getFormVariables() {
      ...
      this.ready = false;
      api
        .getEntity("task/" + this.taskId, "form-variables", null)
        .then(value => {
          for (var key in value) {
            ...
            this.model[key] = value[key].value;
          }
    ...
    addPropsToSchema() {
      ...
      if (this.fieldsOk == true) {
        ...
        button["onSubmit"] = this.generateAndUpdate;
